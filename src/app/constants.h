...
#define CURRENT_SCREEN_PERSON_ID_PTR_BASE 0x06374410
#define CURRENT_SCREEN_PERSON_ID_PTR_BASE_OFFSET_1 0xE0
#define CURRENT_SCREEN_PERSON_ID_PTR_BASE_OFFSET_2 0x10
